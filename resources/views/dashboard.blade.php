        ...
        <!--<div class="form-group">
                        ...
                        <br>
                            <div class="form-group">
                                ...
                                <textarea class=" text-white my-2 rounded-lg text-sm text-center p-2" name="descripcion" id="descripcion"
                                    rows="4"></textarea>

                            </div>

                        <button type="submit"
                            class="mt-5 bg-emerald-400 hover:bg-emerald-600 transition-colors cursor-pointer uppercase font-bold w-auto p-3 text-white rounded-lg">Guardar</button>-->
