...
<div class="mb-5">
    <label class="mb-2 block uppercase text-gray-500 font-bold">
        Descripcion <br>
        <textarea name="body" value="{{ old('body', $post->body) }}" 
        class="border p-3 w-full rounded-lg @error('name') border-red-400 @enderror"> 
        </textarea>
        @error('body')
        <p class="bg-red-500 text-white my-2 rounded-lg text-sm text-center p-2">
...
<label >
    <div class="mb-2 block uppercase text-emerald-400 font-bold">Seleciona una imagen que quieras subir a Finstagram </div> <br>
